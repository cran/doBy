...
It is possible use a list of functions. A typical usage will be
...
This \code{lapplyBy} function is a wrapper for calling lapply on the list resulting
...
Dennis Chabot, Gabor Grothendieck, Paul Murrell and Erik Jørgensen for
